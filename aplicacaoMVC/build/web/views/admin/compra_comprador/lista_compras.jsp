                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            %>
                        <td>
                            <a href="/aplicacaoMVC/admin/CadastraCompraController?acao=Alterar&id=<%=compra.getId()%>" class="btn btn-warning">Alterar</a>
                            <a href="/aplicacaoMVC/admin/CadastraCompraController?acao=Excluir&id=<%=compra.getId()%>" class="btn btn-danger">Excluir</a></td>
