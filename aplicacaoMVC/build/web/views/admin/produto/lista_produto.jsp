    ...
    <body>
        <div class="container">
            ...
            <div class="mt-5">
                ...
                <a href="/aplicacaoMVC/admin/ProdutoController?acao=Incluir" class="mb-2 btn btn-primary">Incluir</a>
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            %>
                        <td>
                            <a href="/aplicacaoMVC/admin/ProdutoController?acao=Alterar&id=<%=produto.getId()%>" class="btn btn-warning">Alterar</a>
                            <a href="/aplicacaoMVC/admin/ProdutoController?acao=Excluir&id=<%=produto.getId()%>" class="btn btn-danger">Excluir</a></td>
