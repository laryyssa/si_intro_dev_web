                ...
                <div class="col-sm-6 mt-5">
                    <form action="/aplicacaoMVC/admin/AdministradorController?acao=Incluir" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="papel" id="papel" class="form-control" <%= "Excluir".equals(acao) ? "" : "disabled"%>>
                                <option value="Administrador" <%= "Administrador".equals(funcionario.getPapel()) ? "selected" : ""%>>Administrador</option>
                                <option value="Vendedor" <%= "Vendedor".equals(funcionario.getPapel()) ? "selected" : ""%>>Vendedor</option>
                                <option value="Comprador" <%= "Comprador".equals(funcionario.getPapel()) ? "selected" : ""%>>Comprador</option>
                            </select>
                        </div>
